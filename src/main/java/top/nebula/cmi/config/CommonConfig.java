...
public class CommonConfig {
	...
	public static final ForgeConfigSpec.IntValue HYDRAULIC_PRESS_STEAM_CAPACITY;
	...
	static {
		...
		BUILDER.comment("Hydraulic Press settings")
				.push("hydraulic_press");
		...
		HYDRAULIC_PRESS_STEAM_CAPACITY = BUILDER
				.comment("Steam capacity in hydraulic press (mB)")
				.comment("type: int")
